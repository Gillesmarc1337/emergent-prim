...
async def get_yearly_analytics(year: int = 2025):
    ...
    try:
        ...
        july_dec_revenue_targets = {
            ...
            'Oct 2025': 1080000, 'Nov 2025': 875000, 'Dec 2025': 715000  # Redistributed to total exactly 4.5M
        }
...
async def get_dashboard_analytics():
    ...
    try:
        ...
        exact_targets = {
            ...
            'Oct': 1080000, 'Nov': 875000, 'Dec': 715000  # Redistributed to total exactly 4.5M
        }
