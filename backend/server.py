...
async def get_yearly_analytics(year: int = 2025):
    ...
    try:
        ...
        july_dec_intro_target = monthly_intro_target * months_elapsed
        ...
        dashboard_blocks = {
            'block_1_meetings': {
                ...
                'inbound_target': 22 * months_elapsed,
                'outbound_actual': actual_outbound_july_dec,
                'outbound_target': 17 * months_elapsed,
                'referral_actual': actual_referral_july_dec,
                'referral_target': 11 * months_elapsed,
