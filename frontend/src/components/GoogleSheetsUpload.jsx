                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div className="space-y-2">
                        ...
                        <Input
                            ...
                            disabled={isUploading}
                        />
                        <p className="text-xs text-gray-500">Leave empty to use the first tab</p>
                    </div>
                    ...
                    <div className="bg-blue-50 p-3 rounded-md">
                        ...
                        <ul className="text-xs text-blue-800 space-y-1">
                            <li>
                                • Make sure your Google Sheet is <strong>public</strong> or shared
                                with read access
                            </li>
                            <li>• Copy the full URL from your browser</li>
                            <li>
                                • The sheet should contain columns: Client, Discovery date, Stage,
                                etc.
                            </li>
                        </ul>
                    </div>
