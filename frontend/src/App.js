...
function SortableTableHeader({ children, sortKey, requestSort, sortConfig, className = '' }) {
    const getSortIcon = () => {
        if (!sortConfig || sortConfig.key !== sortKey) {
            return (
                <ChevronUp className="h-3 w-3 text-gray-400 opacity-0 group-hover:opacity-100" />
            );
        }
    ...
    return (
        <Card className="mb-6">
            ...
            <CardContent>
                ...
                {uploadStatus && (
                    <Alert
                        className={`mt-4 ${uploadStatus.type === 'success' ? 'border-green-500' : 'border-red-500'}`}
                    >
                        ...
                        <>
                            ...
                            {selectedPeriodValue && periodMonths && (
                                <div className="text-xs text-blue-600 font-medium bg-blue-50 px-2 py-1 rounded">
                                    📊 Selected Period: {selectedPeriodValue.toLocaleString()}{' '}
                                    {unit} ({periodMonths} {periodMonths === 1 ? 'month' : 'months'}
                                    )
                                </div>
                            )}
                        ...
                        <div className="flex-1">
                            ...
                            <div className="mt-2 flex items-center gap-2">
                                ...
                                <select
                                    value={probability}
                                    onChange={(e) =>
                                        handleProbabilityChange(Number(e.target.value))
                                    }
                                ...
                                <span className="text-xs font-semibold text-green-600">
                                    $
                                    {(((deal.pipeline || 0) * probability) / 100 / 1000).toFixed(0)}
                                    K proj.
                                </span>
                            </div>
                            {label && (
                    ...
                    <div className="flex items-center justify-between">
                        <div className="flex-1 grid grid-cols-4 gap-2">
                            ...
                            <div className="text-sm text-green-600">
                                MRR: ${lead.expected_mrr?.toLocaleString()}
                            </div>
                            <div className="text-sm text-blue-600">
                                ARR: ${lead.expected_arr?.toLocaleString()}
                            </div>
                        </div>
                        <Button
                            variant="ghost"
                            ...
                            {sortedMeetings.map((meeting, index) => (
                                <tr key={index} className="border-b hover:bg-gray-50">
                                    ...
                                    <td className="p-2">
                                        <Badge
                                            variant={
                                                meeting.closed_status === 'Closed Won'
                                                    ? 'default'
                                                    : meeting.closed_status === 'Closed Lost'
                                                      ? 'destructive'
                                                      : 'secondary'
                                            }
                                        >
...
function DataManagementSection({ onDataUpdated, currentView }) {
    ...
    const handleRefreshGoogleSheet = async () => {
        ...
        try {
            const viewParam = currentView?.id ? `?view_id=${currentView.id}` : '';
            await axios.post(
                `${API}/data/refresh-google-sheet${viewParam}`,
                {},
                {
                    withCredentials: true,
                }
        ...
        <Card className="mb-6">
            ...
            <CardContent>
                <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-4">
                        ...
                        <div>
                            ...
                            <div className="text-sm font-medium">
                                {dataStatus.last_update ? (
                                    <>
                                        {new Date(dataStatus.last_update).toLocaleDateString(
                                            'fr-FR',
                                            {
                                                day: '2-digit',
                                                month: '2-digit',
                                        ...
                                        {' à '}
                                        {new Date(dataStatus.last_update).toLocaleTimeString(
                                            'fr-FR',
                                            {
                                                hour: '2-digit',
                                                minute: '2-digit',
                    ...
                    <div className="flex items-center gap-3 p-3 bg-gray-50 rounded-lg">
                        <div
                            className={`h-3 w-3 rounded-full ${dataStatus.has_data ? 'bg-green-500' : 'bg-red-500'}`}
                        ></div>
                        <div>
    ...
    return (
        <div className="space-y-6">
            ...
            {(() => {
                ...
                const baseNewPipeMonthlyTarget =
                    analytics.pipe_metrics?.created_pipe?.target || 2000000; // Fallback to 2M
                const baseWeightedPipeMonthlyTarget =
                    analytics.pipe_metrics?.created_pipe?.target_weighted || 800000; // Fallback to 800K
                ...
                const newPipeCreated =
                    analytics.dashboard_blocks?.block_3_pipe_creation?.new_pipe_created || 0;
                const weightedPipe =
                    analytics.dashboard_blocks?.block_3_pipe_creation?.weighted_pipe_created || 0;
                    ...
                    <ResponsiveContainer width="100%" height={400}>
                        <BarChart data={dashboardData.monthly_revenue_chart}>
                            ...
                            {visibleSeries['Closed Revenue'] && (
                                <Bar
                                    dataKey="closed_revenue"
                                    fill={REVENUE_COLORS.closed}
                                    name="Closed Revenue"
                                />
                            )}
                            {visibleSeries['Target Revenue'] && (
                                <Bar
                                    ...
                                    fill={REVENUE_COLORS.target}
                                    name="Target Revenue"
                                />
                            )}
                            {visibleSeries['New Weighted Pipe'] && (
                                <Bar
                                    dataKey="new_weighted_pipe"
                                    fill="#D97706"
                                    name="New Weighted Pipe"
                                />
                            )}
                        ...
                        {Object.entries(visibleSeries).map(([seriesName, isVisible]) => {
                            ...
                            return (
                                ...
                                >
                                    ...
                                    />
                                    <span
                                        className={`text-sm ${isVisible ? 'text-gray-700 font-medium' : 'text-gray-500'}`}
                                    >
                                        {seriesName}
                                    </span>
                                </button>
                ...
                <CardContent>
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                        ...
                        <MetricCard
                            ...
                            value={
                                dashboardData.key_metrics.annual_target_2025 -
                                dashboardData.key_metrics.ytd_revenue
                            }
                            unit="$"
                            icon={AlertCircle}
                            color="orange"
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                    ...
                    <Card className="dark:bg-[#1e2128] dark:border-[#2a2d35]">
                        <CardHeader className="pb-3">
                            <CardTitle className="text-lg text-center dark:text-white">
                                Meetings Generation
                            </CardTitle>
                            ...
                            <div className="space-y-3">
                                <div className="text-center">
                                    <div className="text-2xl font-bold text-blue-600 dark:text-blue-400">
                                        {analytics.dashboard_blocks.block_1_meetings.total_actual}/
                                        {analytics.dashboard_blocks.block_1_meetings.total_target}
                                    </div>
                                ...
                                <div className="space-y-2 text-sm dark:text-slate-300">
                                    <div className="flex justify-between">
                                        ...
                                        <span className="font-medium">
                                            {
                                                analytics.dashboard_blocks.block_1_meetings
                                                    .inbound_actual
                                            }
                                            /
                                            {
                                    ...
                                    {analytics.dashboard_blocks.block_1_meetings.unassigned_actual >
                                        0 && (
                                        <div className="flex justify-between">
                            ...
                            <div className="space-y-4">
                                <div className="text-center">
                                    <div className="text-2xl font-bold text-green-600 dark:text-green-400">
                                        {analytics.dashboard_blocks.block_2_intro_poa.intro_actual}/
                                        {analytics.dashboard_blocks.block_2_intro_poa.intro_target}
                                    </div>
                                    <div className="text-sm text-gray-600 dark:text-slate-400">
                                        Intro
                                    </div>
                                ...
                                <div className="text-center">
                                    <div className="text-2xl font-bold text-orange-600 dark:text-orange-400">
                                        {analytics.dashboard_blocks.block_2_intro_poa.poa_actual}/
                                        {analytics.dashboard_blocks.block_2_intro_poa.poa_target}
                                    </div>
                                    <div className="text-sm text-gray-600 dark:text-slate-400">
                                        POA
                                    </div>
                    ...
                    <Card className="border-2 border-purple-200 bg-purple-50 dark:bg-purple-900/20 dark:border-purple-700/50">
                        ...
                        <CardContent className="space-y-2">
                            {(() => {
                                ...
                                const newPipeTarget =
                                    analytics.dashboard_blocks?.block_3_pipe_creation
                                        ?.target_pipe_created || 2000000;
                                const weightedPipeTarget =
                                    analytics.dashboard_blocks?.block_3_pipe_creation
                                        ?.target_weighted_pipe || 800000;

                                const actualNewPipe =
                                    analytics.dashboard_blocks.block_3_pipe_creation
                                        .new_pipe_created || 0;
                                const actualWeightedPipe =
                                    analytics.dashboard_blocks.block_3_pipe_creation
                                        .aggregate_weighted_pipe || 0;
                                    ...
                                    <>
                                        ...
                                        <div className="p-4 bg-white rounded-lg border border-purple-200 shadow-sm">
                                            ...
                                            <div className="w-full bg-gray-200 rounded-full h-2.5">
                                                <div
                                                    className={`h-2.5 rounded-full transition-all ${
                                                        actualWeightedPipe >= weightedPipeTarget
                                                            ? 'bg-green-500'
                                                            : 'bg-orange-500'
                                                    }`}
                                                    style={{
                    ...
                    {analytics.deals_closed_current_period &&
                        (() => {
                            ...
                            const periodStr =
                                analytics.deals_closed_current_period?.period || 'Monthly';

                            // Calculate dynamic targets (monthly target × period)
                            const dealsTarget =
                                tabTargets.deals_closed_tab.deals_closed_target * periodMonths;
                            const arrTarget =
                                tabTargets.deals_closed_tab.arr_closed_target * periodMonths;
                                ...
                                <Card className="border-2 border-blue-200 bg-blue-50">
                                    <CardHeader className="pb-3">
                                        ...
                                        <CardDescription className="text-center font-medium text-blue-600">
                                            {periodStr}{' '}
                                            {periodMonths > 1 ? `(${periodMonths} months)` : ''}
                                        </CardDescription>
                                    </CardHeader>
                                    <CardContent>
...
function Dashboard() {
        ...
        try {
            ...
            if (useCustomDate && dateRange?.from && dateRange?.to) {
                ...
                response = await axios.get(
                    `${API}/analytics/custom?start_date=${startDate}&end_date=${endDate}${viewParam}`
                );
                ...
                // Use monthly offset
                response = await axios.get(
                    `${API}/analytics/monthly?month_offset=${monthOffset}${viewParam}`
                );
    ...
    const loadUpsellRenewData = async () => {
        try {
            ...
            const response = await axios.get(
                `${API}/analytics/upsell-renewals?start_date=${startDate}&end_date=${endDate}${viewParam}`
            );
    ...
    const applyAsherPOV = async () => {
        ...
        try {
            ...
            const newDeals = dealsWithColumns.filter(
                (deal) => !processedDealIds.has(deal.id) && !deletedSet.has(deal.id)
            );
            ...
            if (newDeals.length > 0) {
                console.log(
                    `📝 ${newDeals.length} new deals added to Asher POV:`,
                    newDeals.map((d) => d.client)
                );
            ...
            console.log(
                `👁️ Asher POV loaded for ${viewName}: ${reconstructedDeals.length} deals (${newDeals.length} new), ${deletedSet.size} deleted, ${hiddenSet.size} hidden`
            );
            alert(
                `👁️ Asher's POV applied for ${viewName}!\n\nSaved: ${timestamp}\nDeals: ${reconstructedDeals.length} (${newDeals.length} new)`
            );
        } catch (error) {
    ...
    const saveProjectionsPreferences = async (
        dealsData,
        hiddenDealsSet,
        deletedDealsSet = deletedDeals
    ) => {
        ...
        try {
            ...
            await axios.post(
                `${API}/user/projections-preferences`,
                {
            ...
            console.log(
                '✅ Projections preferences saved successfully (with deleted flag and probabilities)'
            );
        } catch (error) {
    ...
    const loadProjectionsData = async () => {
        ...
        try {
            ...
            console.log(
                `📊 Deals loaded: ${combinedDeals.length} total, ${uniqueDeals.length} unique (${combinedDeals.length - uniqueDeals.length} duplicates removed)`
            );
            ...
            if (savedPreferences) {
                try {
                    ...
                    setOriginalHotDeals(
                        JSON.parse(
                            JSON.stringify(dealsWithColumns.filter((d) => !deletedSet.has(d.id)))
                        )
                    ); // Keep original for reset (excluding deleted)
                    console.log(
                        `✅ Applied saved projections preferences with order, deleted filter, and probabilities`
                    );
                    console.log(
                        `   ${reconstructedDeals.length} total deals (${newDealsSet.size} NEW since last save)`
                    );
    ...
    const onDragEnd = (result) => {
        ...
        if (
            ['next14', 'next30', 'next60', 'delayed'].includes(source.droppableId) ||
    ...
    const handleResetBoard = async () => {
        if (
            window.confirm(
                '⚠️ Are you sure you want to reset all changes? This will restore all deals and clear all deletions, hidden cards, and custom %.'
            )
        ) {
            try {
    ...
    const {
        items: sortedAeIntros,
        requestSort: requestAeIntrosSort,
        sortConfig: aeIntrosSortConfig,
    } = useSortableData(analytics?.ae_performance?.ae_performance || []);
    const {
        items: sortedIntrosDetails,
        requestSort: requestIntrosDetailsSort,
        sortConfig: introsDetailsSortConfig,
    } = useSortableData(analytics?.ae_performance?.intros_details || []);
    const {
        items: sortedAePoa,
        requestSort: requestAePoaSort,
        sortConfig: aePoaSortConfig,
    } = useSortableData(analytics?.ae_performance?.ae_poa_performance || []);
    const {
        items: sortedPoaDetails,
        requestSort: requestPoaDetailsSort,
        sortConfig: poaDetailsSortConfig,
    } = useSortableData(analytics?.ae_performance?.poa_attended_details || []);

    // State for AE Pipeline Breakdown sorting
    const [aePipelineSortConfig, setAePipelineSortConfig] = useState({
        key: 'total',
        direction: 'descending',
    });
    ...
    const {
        items: sortedMeetingDetails,
        requestSort: requestMeetingDetailsSort,
        sortConfig: meetingDetailsSortConfig,
    ...
    const relevanceData = [
        {
            name: 'Relevant',
            value: analytics.meeting_generation.relevance_analysis.relevant,
            color: '#00C49F',
        },
        {
            name: 'Questionable',
            value: analytics.meeting_generation.relevance_analysis.question_mark,
            color: '#FFBB28',
        },
        {
            name: 'Not Relevant',
            value: analytics.meeting_generation.relevance_analysis.not_relevant,
            color: '#FF8042',
        },
    ];
        ...
        <div className="container mx-auto p-4 sm:p-6 max-w-7xl">
                ...
                <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-4 gap-4">
                    ...
                    <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3 sm:gap-4 w-full sm:w-auto">
                        <div className="flex items-center gap-2 flex-wrap">
                            <Button
                                variant={
                                    !useCustomDate && viewMode === 'monthly' ? 'default' : 'outline'
                                }
                                size="sm"
                                onClick={() => {
                            ...
                            <Button
                                variant={
                                    !useCustomDate && viewMode === 'yearly' ? 'default' : 'outline'
                                }
                                size="sm"
                                onClick={() => {
                                    setUseCustomDate(false);
                            ...
                            <div className="flex items-center gap-2">
                                ...
                                <span className="px-3 py-1 text-sm font-medium bg-slate-100 dark:bg-[#24272e] rounded-md whitespace-nowrap">
                                    {forceCurrentMonth
                                        ...
                                        : monthOffset === 0
                                          ? 'Latest Data'
                                          : `${Math.abs(monthOffset)} ${Math.abs(monthOffset) === 1 ? 'month' : 'months'} ${monthOffset > 0 ? 'ago' : 'ahead'}`}
                                </span>
                                <Button
                                    variant="outline"
                                    size="sm"
            ...
            <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-6">
                <TabsList className="w-full flex overflow-x-auto overflow-y-hidden scrollbar-hide">
                    ...
                    <TabsTrigger value="meetings" className="flex-shrink-0 whitespace-nowrap">
                        Meetings Generation
                    </TabsTrigger>
                    <TabsTrigger value="attended" className="flex-shrink-0 whitespace-nowrap">
                        Meetings Attended
                    </TabsTrigger>
                    <TabsTrigger value="upsell" className="flex-shrink-0 whitespace-nowrap">
                        Upsell & Renew
                    </TabsTrigger>
                    <TabsTrigger value="deals" className="flex-shrink-0 whitespace-nowrap">
                        Deals & Pipeline
                    </TabsTrigger>
                ...
                <TabsContent value="meetings">
                    <AnalyticsSection
                        ...
                        conclusion={
                            analytics.meeting_generation.on_track
                    ...
                    >
                        <div className="grid grid-cols-1 md:grid-cols-5 gap-4 mb-6">
                            ...
                            <MetricCard
                                ...
                                value={
                                    analytics.dashboard_blocks?.block_1_meetings?.upsells_actual ||
                                    0
                                }
                                target={
                                    analytics.dashboard_blocks?.block_1_meetings?.upsells_target ||
                                    0
                                }
                                icon={TrendingUp}
                                color="indigo"
                        ...
                        {analytics.meeting_generation.meetings_details &&
                            analytics.meeting_generation.meetings_details.length > 0 &&
                            (() => {
                                ...
                                analytics.meeting_generation.meetings_details.forEach((meeting) => {
                                    if (meeting.discovery_date) {
                                        ...
                                        if (source.toLowerCase().includes('inbound')) {
                                            ...
                                            source.toLowerCase().includes('référence')
                                        ) {
                                            monthlyData[monthKey].Referral++;
                                        } else if (
                                            source.toLowerCase().includes('upsell') ||
                                            source.toLowerCase().includes('cross')
                                        ) {
                                ...
                                const legendData = [
                                    ...
                                    {
                                        key: 'Upsells/Cross-sell',
                                        color: '#6366f1',
                                        label: 'Upsells/Cross-sell',
                                    },
                                ...
                                return (
                                    <Card className="mb-6">
                                        <CardHeader>
                                            ...
                                            <CardDescription>
                                                Total meetings generated per month with breakdown by
                                                source
                                            </CardDescription>
                                        </CardHeader>
                                        <CardContent>
                                            <ResponsiveContainer width="100%" height={350}>
                                                <ComposedChart data={chartData}>
                                                    ...
                                                    {meetingsEvolutionVisibility[
                                                        'Upsells/Cross-sell'
                                                    ] && (
                                                        <Bar
                                                            dataKey="Upsells/Cross-sell"
                                                            fill="#6366f1"
                                                            name="Upsells/Cross-sell"
                                                        />
                                                    )}
                                            ...
                                            <div className="flex flex-wrap justify-center gap-4 mt-4 px-4">
                                                {legendData.map(({ key, color, label }) => (
                                                    ...
                                                    >
                                                        ...
                                                        />
                                                        <span
                                                            className={`text-sm ${meetingsEvolutionVisibility[key] ? 'text-gray-700 font-medium' : 'text-gray-500'}`}
                                                        >
                                                            {label}
                                                        </span>
                                                    </button>
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
                            ...
                            <Card>
                                <CardHeader>
                                    ...
                                    <CardDescription>
                                        Relevance Rate:{' '}
                                        {analytics.meeting_generation.relevance_analysis.relevance_rate.toFixed(
                                            1
                                        )}
                                        %
                                    </CardDescription>
                        ...
                        {analytics.meeting_generation.meetings_details &&
                            ...
                            (() => {
                                ...
                                const getAgingColor = (days) => {
                                    if (days < 30)
                                        return 'bg-green-100 border-green-300 dark:bg-green-900/20 dark:border-green-700/50';
                                    if (days < 60)
                                        return 'bg-orange-100 border-orange-300 dark:bg-orange-900/20 dark:border-orange-700/50';
                                ...
                                const uniqueAEsTracking = Array.from(
                                    new Set(
                                        analytics.meeting_generation.meetings_details
                                            .map((m) => m.owner)
                                            .filter(Boolean)
                                ...
                                const inboxDeals = analytics.meeting_generation.meetings_details
                                    ...
                                    .filter(
                                        (meeting) =>
                                            selectedAE === 'all' || meeting.owner === selectedAE
                                    )
                                    .map((meeting) => ({
                                ...
                                const introAttendedDeals =
                                    analytics.meeting_generation.meetings_details
                                        ...
                                        .map((meeting) => ({
                                            ...
                                            intro_date: meeting.discovery_date,
                                            intro_attended_date:
                                                meeting.intro_attended_date ||
                                                meeting.discovery_date,
                                            days_old: calculateDaysOld(meeting.discovery_date),
                                        }))
                                        .sort((a, b) => b.pipeline - a.pipeline);
                                            ...
                                            <div className="flex items-center justify-between">
                                                <div>
                                                    <CardTitle className="dark:text-white">
                                                        Deal Pipeline Board — Tracking
                                                    </CardTitle>
                                                    <CardDescription className="dark:text-slate-400">
                                                        Track deal progression from Inbox to Intro
                                                        Attended. 🟢 Fresh &lt;30d • 🟠 Aging 30-60d
                                                        • 🔴 Stale &gt;60d
                                                    </CardDescription>
                                                </div>
                                                {/* AE Filter Dropdown */}
                                                ...
                                                <div className="bg-blue-50 dark:bg-blue-900/20 border-2 border-blue-200 dark:border-blue-700/50 rounded-lg p-4">
                                                    <div className="flex items-center justify-between mb-4">
                                                        ...
                                                        <span className="text-sm bg-blue-200 dark:bg-blue-800 text-blue-900 dark:text-blue-200 px-3 py-1 rounded-full font-semibold">
                                                            {inboxDeals.length} deals • $
                                                            {(
                                                                inboxDeals.reduce(
                                                                    (sum, d) => sum + d.pipeline,
                                                                    0
                                                                ) / 1000
                                                            ).toFixed(0)}
                                                            K
                                                            ...
                                                            return (
                                                                ...
                                                                >
                                                                    <div className="flex items-start justify-between mb-2">
                                                                        ...
                                                                        <span
                                                                            className={`${agingBadge.color} text-white text-xs px-2 py-1 rounded-full`}
                                                                        >
                                                                            {agingBadge.text}
                                                                        </span>
                                                                    </div>
                                                ...
                                                <div className="bg-purple-50 dark:bg-purple-900/20 border-2 border-purple-200 dark:border-purple-700/50 rounded-lg p-4">
                                                    <div className="flex items-center justify-between mb-4">
                                                        ...
                                                        <span className="text-sm bg-purple-200 dark:bg-purple-800 text-purple-900 dark:text-purple-200 px-3 py-1 rounded-full font-semibold">
                                                            {introAttendedDeals.length} deals • $
                                                            {(
                                                                introAttendedDeals.reduce(
                                                                    (sum, d) => sum + d.pipeline,
                                                                    0
                                                                ) / 1000
                                                            ).toFixed(0)}
                            ...
                            analytics.meeting_generation.meetings_details.length > 0 && (
                                <Card className="mt-6">
                                    <CardHeader>
                                        ...
                                        <CardDescription>
                                            Detailed list of all meetings with filters and sorting
                                        </CardDescription>
                                    </CardHeader>
                                    <CardContent>
                                        {/* Filters */}
                                        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-4">
                                            <div>
                                                ...
                                                <select
                                                    ...
                                                    onChange={(e) =>
                                                        setMeetingDetailsFilters({
                                                            ...meetingDetailsFilters,
                                                            bdr: e.target.value,
                                                        })
                                                    }
                                                >
                                                ...
                                                <tbody>
                                                    {sortedMeetingDetails
                                                        .filter((meeting) => {
                                                            ...
                                                            if (
                                                                meetingDetailsFilters.relevance !==
                                                                    'all' &&
                                                                meeting.relevance !==
                                                                    meetingDetailsFilters.relevance
                                                            )
                                                        ...
                                                        .map((meeting, index) => (
                                                            ...
                                                            >
                                                                ...
                                                                <td className="p-2 text-center">
                                                                    <span
                                                                        className={`inline-flex items-center w-3 h-3 rounded-full ${
                                                                            meeting.relevance ===
                                                                            'Relevant'
                                                                                ? 'bg-green-500'
                                                                                : meeting.relevance ===
                                        ...
                                        <div className="mt-4 text-sm text-gray-600">
                                            Showing{' '}
                                            {
                                                sortedMeetingDetails.filter((meeting) => {
                                                    if (
                                                        meetingDetailsFilters.bdr !== 'all' &&
                                                        meeting.bdr !== meetingDetailsFilters.bdr
                                                    )
                                                        return false;
                                                    ...
                                                    if (
                                                        meetingDetailsFilters.relevance !== 'all' &&
                                                        meeting.relevance !==
                                                            meetingDetailsFilters.relevance
                                                    )
                                                        return false;
                                                    if (
                                                        meetingDetailsFilters.stage !== 'all' &&
                                                        meeting.stage !==
                                                            meetingDetailsFilters.stage
                                                    )
                                                        return false;
                                            ...
                                            of {sortedMeetingDetails.length} meetings
                                        </div>
                                    </CardContent>
                                </Card>
                            )}
                                        ...
                                        <CardContent>
                                            <div className="overflow-x-auto">
                                                <table className="w-full text-sm">
                                                    ...
                                                    <tbody>
                                                        {Object.entries(filteredBDRPerformance).map(
                                                            ([bdr, stats]) => {
                ...
                <TabsContent value="attended">
                    <AnalyticsSection
                        ...
                        conclusion={
                            analytics.meetings_attended.on_track
                    ...
                    >
                        {(() => {
                            ...
                            const dynamicMeetingsScheduledTarget =
                                tabTargets.meetings_attended_tab.meetings_scheduled_target *
                                periodMonths;
                            const dynamicPOAGeneratedTarget =
                                tabTargets.meetings_attended_tab.poa_generated_target *
                                periodMonths;
                            const dynamicDealsClosedTarget =
                                tabTargets.meetings_attended_tab.deals_closed_target * periodMonths;

                            // Calculate achievement percentages
                            const meetingsScheduledAchievement =
                                (analytics.meetings_attended.intro_metrics.scheduled /
                                    dynamicMeetingsScheduledTarget) *
                                100;
                            const poaGeneratedAchievement =
                                (analytics.meetings_attended.poa_generated_metrics.completed /
                                    dynamicPOAGeneratedTarget) *
                                100;
                            const dealsClosedAchievement =
                                (analytics.meetings_attended.deals_closed_metrics.generated /
                                    dynamicDealsClosedTarget) *
                                100;
                            ...
                            return (
                                <>
                                    ...
                                    <div className="mb-4 p-3 bg-gray-50 rounded-lg border">
                                        <div className="text-sm text-gray-600">
                                            <strong>Selected Period:</strong> {periodMonths} month
                                            {periodMonths > 1 ? 's' : ''}
                                            {viewMode === 'yearly'
                                                ? ' (July–December 2025)'
                                                : useCustomDate
                                    ...
                                    <Card className="mb-6 border-blue-200">
                                        <CardHeader className="bg-blue-50">
                                            ...
                                            <CardDescription>
                                                Meeting scheduling, attendance and intro metrics
                                        ...
                                        <CardContent className="pt-6">
                                            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                                                <MetricCard
                                                    ...
                                                    value={
                                                        analytics.meetings_attended.intro_metrics
                                                            .scheduled
                                                    }
                                                    target={dynamicMeetingsScheduledTarget}
                                                    icon={Calendar}
                                                    color={
                                                        meetingsScheduledAchievement >= 80
                                                            ? 'green'
                                                            : meetingsScheduledAchievement >= 60
                                                              ? 'orange'
                                                              : 'red'
                                                    }
                                                    statusBadge={
                                                ...
                                                <MetricCard
                                                    ...
                                                    value={analytics.meetings_attended.intro_metrics.attendance_rate.toFixed(
                                                        1
                                                    )}
                                                    unit="%"
                                                    icon={BarChart3}
                                    ...
                                    <Card className="mb-6 border-purple-200">
                                        <CardHeader className="bg-purple-50">
                                            ...
                                            <CardDescription>
                                                POA generation and deal closing metrics with dynamic
                                                targets
                                            </CardDescription>
                                        </CardHeader>
                                        <CardContent className="pt-6">
                                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                                <MetricCard
                                                    title="POA Generated"
                                                    value={
                                                        analytics.meetings_attended
                                                            .poa_generated_metrics.completed
                                                    }
                                                    target={dynamicPOAGeneratedTarget}
                                                    icon={Target}
                                                    color={
                                                        poaGeneratedAchievement >= 80
                                                            ? 'green'
                                                            : poaGeneratedAchievement >= 60
                                                              ? 'orange'
                                                              : 'red'
                                                    }
                                                    statusBadge={
                                                ...
                                                <MetricCard
                                                    ...
                                                    value={
                                                        analytics.meetings_attended
                                                            .deals_closed_metrics.generated
                                                    }
                                                    target={dynamicDealsClosedTarget}
                                                    icon={DollarSign}
                                                    color={
                                                        dealsClosedAchievement >= 80
                                                            ? 'green'
                                                            : dealsClosedAchievement >= 60
                                                              ? 'orange'
                                                              : 'red'
                                                    }
                                                    statusBadge={
                                    ...
                                    {analytics.meetings_attended.monthly_breakdown &&
                                        analytics.meetings_attended.monthly_breakdown.months &&
                                        analytics.meetings_attended.monthly_breakdown.months
                                            .length > 0 &&
                                        (() => {
                                            const chartData =
                                                analytics.meetings_attended.monthly_breakdown.months.map(
                                                    (month, index) => ({
                                                        month,
                                                        attended:
                                                            analytics.meetings_attended
                                                                .monthly_breakdown.attended[index],
                                                        poa_generated:
                                                            analytics.meetings_attended
                                                                .monthly_breakdown.poa_generated[
                                                                index
                                                            ],
                                                        deals_closed:
                                                            analytics.meetings_attended
                                                                .monthly_breakdown.deals_closed[
                                                                index
                                                            ],
                                                    })
                                                );
                                            ...
                                            return (
                                                <Card className="mb-6">
                                                    <CardHeader>
                                                        <CardTitle>
                                                            Monthly Meetings Attended Evolution
                                                        </CardTitle>
                                                        <CardDescription>
                                                            Track attended meetings, POA generated,
                                                            and deals closed on a monthly basis
                                                            ...
                                                            {legendData.map(
                                                                ({ key, color, label }) => (
                                                                    ...
                                                                    >
                                                                        ...
                                                                        />
                                                                        <span
                                                                            className={`text-sm ${attendedChartVisibility[key] ? 'text-gray-700 font-medium' : 'text-gray-500'}`}
                                                                        >
                                                                            {label}
                                                                        </span>
                                                                    </button>
                                    ...
                                    {analytics.meeting_generation?.meetings_details &&
                                        ...
                                        (() => {
                                            ...
                                            // Get unique AEs for filter dropdown
                                            const uniqueAEsAdvanced = Array.from(
                                                new Set(
                                                    analytics.meeting_generation.meetings_details
                                                        .map((m) => m.owner)
                                                        .filter(Boolean)
                                            ...
                                            const poaBookedDeals =
                                                analytics.meeting_generation.meetings_details
                                                    ...
                                                    .map((meeting) => ({
                                                        ...
                                                        days_old: calculateDaysOld(
                                                            meeting.discovery_date
                                                        ),
                                                    }))
                                                    .sort((a, b) => b.pipeline - a.pipeline);

                                            const proposalSentDeals =
                                                analytics.meeting_generation.meetings_details
                                                    .filter(
                                                        (meeting) =>
                                                ...
                                                <Card className="mb-6 dark:bg-[#1e2128] dark:border-[#2a2d35]">
                                                    <CardHeader>
                                                        <div className="flex items-center justify-between">
                                                            <div>
                                                                <CardTitle className="dark:text-white">
                                                                    Deal Pipeline Board — Advanced
                                                                    Stages
                                                                </CardTitle>
                                                                <CardDescription className="dark:text-slate-400">
                                                                    Track deal progression from POA
                                                                    Booked → Proposal Sent. 🟢 Fresh
                                                                    &lt;30d • 🟠 Aging 30-60d • 🔴
                                                                    Stale &gt;60d
                                                                </CardDescription>
                                                            </div>
                                                        ...
                                                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                                            ...
                                                            <div className="bg-purple-50 dark:bg-purple-900/20 border-2 border-purple-200 dark:border-purple-700/50 rounded-lg p-4">
                                                                <div className="flex items-center justify-between mb-4">
                                                                    ...
                                                                    <span className="text-sm bg-purple-200 dark:bg-purple-800 text-purple-900 dark:text-purple-200 px-3 py-1 rounded-full font-semibold">
                                                                        {poaBookedDeals.length} • $
                                                                        {(
                                                                            poaBookedDeals.reduce(
                                                                                (sum, d) =>
                                                                                    sum +
                                                                                    d.pipeline,
                                                                                0
                                                            ...
                                                            <div className="bg-indigo-50 dark:bg-indigo-900/20 border-2 border-indigo-200 dark:border-indigo-700/50 rounded-lg p-4">
                                                                <div className="flex items-center justify-between mb-4">
                                                                    ...
                                                                    <span className="text-sm bg-indigo-200 dark:bg-indigo-800 text-indigo-900 dark:text-indigo-200 px-3 py-1 rounded-full font-semibold">
                                                                        {proposalSentDeals.length} •
                                                                        $
                                                                        {(
                                                                            proposalSentDeals.reduce(
                                                                                (sum, d) =>
                                                                                    sum +
                                                                                    d.pipeline,
                                                                                0
                        ...
                        <Card className="mb-6 border-green-200">
                            <CardHeader className="bg-green-50">
                                ...
                                <CardDescription>
                                    Individual AE performance for meetings, intros, and POA
                                </CardDescription>
                            </CardHeader>
                            <CardContent className="pt-6">
                                                        ...
                                                        <thead>
                                                            <tr className="border-b sticky top-0 bg-white">
                                                                <SortableTableHeader
                                                                    sortKey="date"
                                                                    requestSort={
                                                                        requestIntrosDetailsSort
                                                                    }
                                                                    sortConfig={
                                                                        introsDetailsSortConfig
                                                                    }
                                                                    className="text-left p-2 font-semibold"
                                                                >
                                                                    Date
                                                        ...
                                                        <thead>
                                                            <tr className="border-b sticky top-0 bg-white">
                                                                <SortableTableHeader
                                                                    sortKey="date"
                                                                    requestSort={
                                                                        requestPoaDetailsSort
                                                                    }
                                                                    sortConfig={
                                                                        poaDetailsSortConfig
                                                                    }
                                                                    className="text-left p-2 font-semibold"
                                                                >
                                                                    Date
                        ...
                        <Card className="mb-6 border-orange-200">
                            <CardHeader className="bg-orange-50">
                                ...
                                <CardDescription>
                                    Intro to POA and POA to Closing conversion metrics by AE
                                </CardDescription>
                            </CardHeader>
                            <CardContent className="pt-6">
                                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                                    ...
                                    <Card>
                                        <CardHeader>
                                            ...
                                            <CardDescription>
                                                Conversion from Intros Attended to POA Generated
                                            </CardDescription>
                                        </CardHeader>
                                        <CardContent>
                                            {/* Global Rate */}
                                            <div className="mb-6 p-4 bg-blue-50 rounded-lg">
                                                <div className="text-center">
                                                    <div className="text-3xl font-bold text-blue-600">
                                                        {analytics.meetings_attended.conversion_rates.intro_to_poa.global_rate.toFixed(
                                                            1
                                                        )}
                                                        %
                                                    </div>
                                            ...
                                            <div className="overflow-x-auto">
                                                <table className="w-full text-sm">
                                                    ...
                                                    <tbody>
                                                        {analytics.meetings_attended.conversion_rates.intro_to_poa.by_ae.map(
                                                            (ae, index) => (
                                                                <tr
                                                                    key={index}
                                                                    className="border-b hover:bg-gray-50"
                                    ...
                                    <Card>
                                        <CardHeader>
                                            ...
                                            <CardDescription>
                                                Conversion from POA Generated to Deals Closed
                                            </CardDescription>
                                        </CardHeader>
                                        <CardContent>
                                            {/* Global Rate */}
                                            <div className="mb-6 p-4 bg-green-50 rounded-lg">
                                                <div className="text-center">
                                                    <div className="text-3xl font-bold text-green-600">
                                                        {analytics.meetings_attended.conversion_rates.poa_to_closing.global_rate.toFixed(
                                                            1
                                                        )}
                                                        %
                                                    </div>
                                                    ...
                                                    <div className="text-xs text-gray-500 mt-1">
                                                        {
                                                            analytics.meetings_attended
                                                                .conversion_rates.poa_to_closing
                                                                .total_closed
                                                        }{' '}
                                                        Closed /{' '}
                                                        {
                                            ...
                                            <div className="overflow-x-auto">
                                                <table className="w-full text-sm">
                                                    ...
                                                    <tbody>
                                                        {analytics.meetings_attended.conversion_rates.poa_to_closing.by_ae.map(
                                                            (ae, index) => (
                                                                <tr
                                                                    key={index}
                                                                    className="border-b hover:bg-gray-50"
                ...
                <TabsContent value="deals">
                    <div className="space-y-6">
                        ...
                        <AnalyticsSection
                            ...
                            conclusion={
                                analytics.deals_closed.on_track
                            ...
                            {(() => {
                                ...
                                return (
                                    <>
                                        ...
                                        {analytics.deals_closed.monthly_closed &&
                                            analytics.deals_closed.monthly_closed.length > 0 && (
                                                <Card className="mb-6">
                                                    <CardHeader>
                                                        <CardTitle>
                                                            Monthly Deals Closed Trend
                                                        </CardTitle>
                                                    </CardHeader>
                                                    <CardContent>
                                                        <ResponsiveContainer
                                                ...
                                                <CardContent>
                                                    <div className="overflow-x-auto">
                                                        <table className="w-full text-sm">
                                                            ...
                                                            <tbody>
                                                                {analytics.deals_closed.deals_detail.map(
                                                                    (deal, index) => (
                                                                        <tr
                                                                            key={index}
                                                                            className="border-b"
                                                                        >
                                                                            ...
                                                                            <td className="text-right p-2">
                                                                                $
                                                                                {deal.expected_arr?.toLocaleString()}
                                                                            </td>
                                                                            <td className="p-2">
                                                                                {deal.owner}
                                                                            </td>
                        ...
                        <AnalyticsSection
                            ...
                            conclusion={
                                analytics.pipe_metrics.total_pipe.on_track
                        ...
                        >
                            ...
                            <div className="mb-4 p-3 bg-gray-50 rounded-lg border">
                                <div className="font-semibold text-gray-800 mb-1">
                                    🧮 Excel-Based Weighted Calculation
                                </div>
                                <div className="text-xs text-gray-600">
                                    Weighted values calculated using exact Excel formula: Stage
                                    probability × Source factor × Recency adjustment
                                    <br />
                                    <strong>Stages:</strong> E Intro attended, D POA Booked, C
                                    Proposal sent, B Legals
                                    <br />
                                    <strong>Sources:</strong> Outbound, Inbound, Client referral,
                                    Internal referral, Partnership
                                </div>
                            </div>
                            ...
                            {(() => {
                                ...
                                const backendPipeTarget =
                                    analytics.dashboard_blocks?.block_3_pipe_creation
                                        ?.target_pipe_created || baseNewPipeMonthlyTarget;
                                ...
                                const dynamicWeightedPipeTarget =
                                    baseWeightedPipeMonthlyTarget * periodMonths; // 800K × months
                                ...
                                const weightedPipe =
                                    analytics.dashboard_blocks?.block_3_pipe_creation
                                        ?.weighted_pipe_created || 0;

                                // YTD targets - get from backend view_targets, with fallback to defaults
                                const fixedYTDPipelineTarget =
                                    analytics.view_targets?.dashboard?.ytd_aggregate_pipeline ||
                                    7500000; // Default: $7.5M
                                const fixedYTDWeightedTarget =
                                    analytics.view_targets?.dashboard?.ytd_cumulative_weighted ||
                                    2500000; // Default: $2.5M
                            ...
                            <div className="mb-6 p-4 bg-blue-50 rounded-lg border border-blue-200">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm text-blue-700">
                                    <div>
                                        <span className="font-medium">
                                            Blocks 1 & 2 (Period-Based):
                                        </span>{' '}
                                        New Pipe Created and Created Weighted Pipe for selected
                                        period. Targets multiply by period duration (Monthly:
                                        2M/800K, July-Dec: 12M/4.8M).
                                    </div>
                                    <div>
                                        <span className="font-medium">
                                            Blocks 3 & 4 (YTD Cumulative):
                                        </span>{' '}
                                        YTD Aggregate Pipeline (excl. Closed/Lost/Not Relevant) and
                                        YTD Weighted Pipe (excl. Wins/Lost/Not Relevant). Fixed
                                        targets: 7.5M and 2.5M.
                                    </div>
                                    <div>
                                        <span className="font-medium">Weighted Value:</span> Uses
                                        Excel formula with stage × source × recency factors
                                    </div>
                                    <div>
                                        <span className="font-medium">Target Logic:</span> Blocks
                                        1-2 dynamic (scale with period), Blocks 3-4 fixed (never
                                        change)
                                    </div>
                                </div>
                            </div>
                            ...
                            {analytics.pipe_metrics.monthly_breakdown &&
                                analytics.pipe_metrics.monthly_breakdown.months &&
                                analytics.pipe_metrics.monthly_breakdown.months.length > 0 &&
                                (() => {
                                    // Filter data to start from July
                                    const allChartData =
                                        analytics.pipe_metrics.monthly_breakdown.months.map(
                                            (month, index) => ({
                                                month,
                                                sortKey: month, // For sorting
                                                new_pipe_created:
                                                    analytics.pipe_metrics.monthly_breakdown
                                                        .new_pipe_created[index],
                                                new_weighted_pipe:
                                                    analytics.pipe_metrics.monthly_breakdown
                                                        .new_weighted_pipe[index],
                                                total_pipe:
                                                    analytics.pipe_metrics.monthly_breakdown
                                                        .total_pipe[index],
                                                total_weighted:
                                                    analytics.pipe_metrics.monthly_breakdown
                                                        .total_weighted[index],
                                            })
                                        );
                                    ...
                                    const legendData = [
                                        {
                                            key: 'new_pipe_created',
                                            color: '#8b5cf6',
                                            label: 'New Pipe Created',
                                        },
                                        {
                                            key: 'new_weighted_pipe',
                                            color: '#3b82f6',
                                            label: 'New Weighted Pipe',
                                        },
                                        {
                                            key: 'total_pipe',
                                            color: '#10b981',
                                    ...
                                    return (
                                        <Card className="mb-6">
                                            <CardHeader>
                                                ...
                                                <CardDescription>
                                                    Track new pipeline created and total pipeline
                                                    value on a monthly basis (click legend to
                                                    toggle)
                                                </CardDescription>
                                            </CardHeader>
                                            <CardContent>
                                                <ResponsiveContainer width="100%" height={350}>
                                                    <ComposedChart data={chartData}>
                                                        ...
                                                        />
                                                        {pipelineEvolutionVisibility.new_pipe_created && (
                                                            <Bar
                                                                dataKey="new_pipe_created"
                                                                fill="#8b5cf6"
                                                                name="New Pipe Created"
                                                            />
                                                        )}
                                                        {pipelineEvolutionVisibility.new_weighted_pipe && (
                                                            <Bar
                                                                dataKey="new_weighted_pipe"
                                                                fill="#3b82f6"
                                                                name="New Weighted Pipe"
                                                        ...
                                                        {pipelineEvolutionVisibility.total_pipe !==
                                                            false && (
                                                            <Line
                                                                type="monotone"
                                                                dataKey="total_pipe"
                                                        ...
                                                        {pipelineEvolutionVisibility.total_weighted !==
                                                            false && (
                                                            <Line
                                                                type="monotone"
                                                                dataKey="total_weighted"
                                                                stroke="#f97316"
                                                                strokeWidth={2}
                                                                strokeDasharray="5 5"
                                                                name="Total Weighted"
                                                ...
                                                <div className="flex flex-wrap justify-center gap-4 mt-4 px-4">
                                                    {legendData.map(({ key, color, label }) => (
                                                        <button
                                                            ...
                                                            onClick={() => handleLegendClick(key)}
                                                            className={`flex items-center gap-2 px-3 py-2 rounded-md transition-all ${
                                                                pipelineEvolutionVisibility[key] !==
                                                                false
                                                                    ? 'bg-white shadow-sm border border-gray-200'
                                                                    : 'bg-gray-100 opacity-60 hover:opacity-80'
                                                            }`}
                                                        >
                                                            ...
                                                            />
                                                            <span
                                                                className={`text-sm ${pipelineEvolutionVisibility[key] !== false ? 'text-gray-700 font-medium' : 'text-gray-500'}`}
                                                            >
                                                                {label}
                                                            </span>
                                                        </button>
                            ...
                            {/* AE Breakdown Table */}
                            {analytics.pipe_metrics.ae_breakdown &&
                                analytics.pipe_metrics.ae_breakdown.length > 0 &&
                                (() => {
                                    // Function to sort AE breakdown
                                    const sortAEBreakdown = (key) => {
                                        let direction = 'asc';
                                        if (
                                            aeSortConfig.key === key &&
                                            aeSortConfig.direction === 'asc'
                                        ) {
                                            direction = 'desc';
                                        }
                                    ...
                                    const sortedAEBreakdown = [
                                        ...
                                        if (aValue < bValue)
                                            return aeSortConfig.direction === 'asc' ? -1 : 1;
                                        if (aValue > bValue)
                                            return aeSortConfig.direction === 'asc' ? 1 : -1;
                                        return 0;
                                    });
                            ...
                            {/* Pipeline Details */}
                            {analytics.pipe_metrics.pipe_details &&
                                analytics.pipe_metrics.pipe_details.length > 0 && (
                                    <Card>
                                        <CardHeader>
                                        ...
                                        <CardContent>
                                            <div className="overflow-x-auto">
                                                <table className="w-full text-sm">
                                                    ...
                                                    <tbody>
                                                        {analytics.pipe_metrics.pipe_details.map(
                                                            (deal, index) => (
                                                                <tr
                                                                    key={index}
                                                                    className="border-b hover:bg-gray-50"
                    ...
                    {upsellRenewData ? (
                        <div className="space-y-6">
                            <AnalyticsSection
                                ...
                                isOnTrack={
                                    upsellRenewData.closing_value >=
                                    upsellRenewData.closing_value_target
                                }
                                conclusion={
                                    upsellRenewData.closing_value >=
                                    upsellRenewData.closing_value_target
                            ...
                            >
                                ...
                                {(() => {
                                    ...
                                    const monthlyClosingValueTarget =
                                        monthlyClosingTarget * avgDealValue; // 4 × 60K = 240K

                                    // Calculate period multiplier
                                    const periodMonths =
                                        upsellRenewData.period_duration_months || 1;
                                    ...
                                    const periodClosingValueTarget =
                                        monthlyClosingValueTarget * periodMonths;
                                ...
                                <Card className="mb-6">
                                    ...
                                    <CardContent>
                                        {(() => {
                                            ...
                                            const introsDetails =
                                                upsellRenewData?.intros_details || [];
                                            ...
                                            [...introsDetails, ...poaDetails].forEach((deal) => {
                                                ...
                                                if (
                                                    (deal.type_of_deal === 'Upsell' ||
                                                        deal.type_of_deal === 'Cross-sell') &&
                                                    deal.partner
                                                ) {
                                                    ...
                                                    partnerStats[partnerName].total_arr +=
                                                        deal.expected_arr || 0;
                                            ...
                                            const partnerList = Object.values(partnerStats).sort(
                                                (a, b) => b.total_arr - a.total_arr
                                            );
                                ...
                                {upsellRenewData &&
                                    upsellRenewData.monthly_breakdown &&
                                    upsellRenewData.monthly_breakdown.months &&
                                    upsellRenewData.monthly_breakdown.months.length > 0 &&
                                    (() => {
                                        const chartData =
                                            upsellRenewData.monthly_breakdown.months.map(
                                                (month, index) => ({
                                                    month,
                                                    intro_meetings:
                                                        upsellRenewData.monthly_breakdown
                                                            .meetings_attended[index],
                                                    poa_attended:
                                                        upsellRenewData.monthly_breakdown
                                                            .poa_generated[index],
                                                    deals_closed:
                                                        upsellRenewData.monthly_breakdown
                                                            .revenue_generated[index],
                                                })
                                            );
                                        ...
                                        return (
                                            <Card className="mb-6">
                                                <CardHeader>
                                                    <CardTitle>
                                                        Monthly Upsell & Renew Evolution
                                                    </CardTitle>
                                                    <CardDescription>
                                                        Track upsell/renew meetings, POA generated,
                                                        and revenue on a monthly basis (click legend
                                                        to toggle)
                                                    </CardDescription>
                                                </CardHeader>
                                                <CardContent>
                                                    <ResponsiveContainer width="100%" height={350}>
                                                        <ComposedChart data={chartData}>
                                                            ...
                                                            />
                                                            {upsellEvolutionVisibility.intro_meetings && (
                                                                <Bar
                                                                    yAxisId="left"
                                                                    dataKey="intro_meetings"
                                                                    fill="#6366f1"
                                                                    name="Intro Meetings"
                                                                />
                                                            )}
                                                            {upsellEvolutionVisibility.poa_attended && (
                                                                <Bar
                                                                    yAxisId="left"
                                                                    dataKey="poa_attended"
                                                                    fill="#10b981"
                                                                    name="POA Attended"
                                                                />
                                                            )}
                                                            {upsellEvolutionVisibility.deals_closed && (
                                                                <Line
                                                                    yAxisId="right"
                                                                    type="monotone"
                                                                    dataKey="deals_closed"
                                                    ...
                                                    <div className="flex flex-wrap justify-center gap-4 mt-4 px-4">
                                                        {legendData.map(({ key, color, label }) => (
                                                            ...
                                                            >
                                                                ...
                                                                />
                                                                <span
                                                                    className={`text-sm ${upsellEvolutionVisibility[key] ? 'text-gray-700 font-medium' : 'text-gray-500'}`}
                                                                >
                                                                    {label}
                                                                </span>
                                                            </button>
                                ...
                                {upsellRenewData.intros_details &&
                                    upsellRenewData.intros_details.length > 0 && (
                                        <Card>
                                            <CardHeader>
                                                <CardTitle className="flex items-center justify-between">
                                            ...
                                            <CardContent>
                                                <div className="overflow-x-auto">
                                                    <table className="w-full text-sm">
                                                        ...
                                                        <tbody>
                                                            {upsellRenewData.intros_details.map(
                                                                (intro, index) => (
                                                                    <tr
                                                                        key={index}
                                                                        className="border-b hover:bg-gray-50"
                                ...
                                {upsellRenewData.poa_details &&
                                    upsellRenewData.poa_details.length > 0 && (
                                        <Card>
                                            <CardHeader>
                                                <CardTitle className="flex items-center justify-between">
                                            ...
                                            <CardContent>
                                                <div className="overflow-x-auto">
                                                    <table className="w-full text-sm">
                                                        ...
                                                        <tbody>
                                                            {upsellRenewData.poa_details.map(
                                                                (poa, index) => (
                                                                    <tr
                                                                        key={index}
                                                                        className="border-b hover:bg-gray-50"
                    ...
                    <div className="space-y-6">
                        ...
                        <Card className="dark:bg-[#1e2128] dark:border-[#2a2d35]">
                            <CardHeader>
                                ...
                                <CardDescription className="dark:text-slate-400">
                                    Pipeline metrics with advanced weighting methodology
                                </CardDescription>
                                ...
                                <div className="mt-3 p-3 bg-gray-50 dark:bg-[#252729] rounded-lg text-xs border dark:border-[#2a2d35]">
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-3 gap-2 text-xs">
                                        ...
                                        <div className="dark:text-slate-300">
                                            ...
                                            <br />
                                            Pondéré par stage/source/temps
                                        </div>
                                        <div className="dark:text-slate-300">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
                                    ...
                                    <Card className="border-2 border-purple-200 bg-purple-50 dark:bg-purple-900/20 dark:border-purple-700/50">
                                        ...
                                        <CardContent>
                                            {(() => {
                                                ...
                                                const legalsDeals = filteredDeals.filter(
                                                    (deal) => deal.stage === 'B Legals'
                                                );
                                                return (
                                                    <>
                                    ...
                                    <Card className="border-2 border-indigo-200 bg-indigo-50 dark:bg-indigo-900/20 dark:border-indigo-700/50">
                                        ...
                                        <CardContent>
                                            {(() => {
                                                const filteredDeals = getFilteredDeals();
                                                const proposalDeals = filteredDeals.filter(
                                                    (deal) => deal.stage === 'C Proposal sent'
                                                );
                                                return (
                                                    <>
                                    ...
                                    <Card className="border-2 border-blue-200 bg-blue-50">
                                        ...
                                        <CardContent>
                                            {(() => {
                                                ...
                                                const upcomingPOAs = filteredDeals.filter(
                                                    (deal) => {
                                                        const poaDate = deal.poa_date
                                                            ? new Date(deal.poa_date)
                                                            : null;
                                                        return poaDate && poaDate > today;
                                                    }
                                                );
                                                const upcomingCount = upcomingPOAs.length;
                                                const upcomingValue = upcomingPOAs.reduce(
                                                    (sum, deal) =>
                                                        sum + (parseFloat(deal.expected_arr) || 0),
                                                    0
                                                );
                                    ...
                                    const upcomingMeetings = [
                                        ...
                                        .filter((deal) => {
                                            ...
                                            const poaDate = deal.poa_date
                                                ? new Date(deal.poa_date)
                                                : null;
                                            const discoveryDate = deal.discovery_date
                                                ? new Date(deal.discovery_date)
                                                : null;
                                    ...
                                    return upcomingMeetings.length > 0 ? (
                                        <Card className="mb-6 bg-yellow-50 border-yellow-200">
                                            <CardHeader>
                                                ...
                                                <CardDescription>
                                                    POA and Discovery meetings scheduled in the next
                                                    week
                                                </CardDescription>
                                            </CardHeader>
                                            <CardContent>
                                                <div className="grid grid-cols-1 lg:grid-cols-2 gap-3">
                                                    {upcomingMeetings.map((deal, index) => {
                                                        ...
                                                        const discoveryDate = deal.discovery_date
                                                            ...
                                                            : null;
                                                        const meetingDate =
                                                            poaDate || discoveryDate;
                                                        const meetingType = poaDate
                                                            ? 'POA'
                                                            : 'Discovery';
                        ...
                        {analytics.meetings_attended?.upcoming_poa &&
                            analytics.meetings_attended.upcoming_poa.filter((poa) => {
                                ...
                                <Card className="mb-6">
                                    <CardHeader>
                                        ...
                                        <CardDescription>
                                            POA meetings scheduled in the next week
                                        </CardDescription>
                                    </CardHeader>
                                    <CardContent>
                            ...
                            <CardHeader>
                                <div className="flex items-center justify-between">
                                    <div className="flex-1">
                                        ...
                                        <CardDescription>
                                            Drag & drop deals to simulate closing timelines. Changes
                                            are visual only and don't affect source data.
                                        </CardDescription>
                                    </div>
                                            ...
                                            <div className="mb-4">
                                                ...
                                                {(() => {
                                                    ...
                                                    const columnValue = columnDeals.reduce(
                                                        (sum, deal) => sum + (deal.pipeline || 0),
                                                        0
                                                    );
                                                    const weightedValue = columnDeals.reduce(
                                                        (sum, deal) => {
                                                            const prob =
                                                                dealProbabilities[deal.id] || 75;
                                                            return (
                                                                sum +
                                                                ((deal.pipeline || 0) * prob) / 100
                                                            );
                                                        },
                                                        0
                                                    );
                                                    ...
                                                    const columnTarget =
                                                        viewConfig?.targets?.closing_projections
                                                            ?.next_30_days_target || 250000;
                                                    const percentage = Math.round(
                                                        (weightedValue / columnTarget) * 100
                                                    );
                                                        ...
                                                        {getFilteredDeals()
                                                            ...
                                                            .map((deal, index) => (
                                                                <DraggableDealItem
                                                                    ...
                                                                    showActions={true}
                                                                    onHide={() =>
                                                                        hideItem('deals', deal.id)
                                                                    }
                                                                    onDelete={handleDeleteDeal}
                                                                    onProbabilityChange={
                                                                        handleDealProbabilityChange
                                                                    }
                                                        ...
                                                        {getFilteredDeals().filter(
                                                            ...
                                                            <div className="text-center text-gray-400 text-sm mt-8">
                                                                ...
                                                                <p className="text-xs mt-1">
                                                                    Drag deals here if potentially
                                                                    delayed
                                                                </p>
                                                            </div>
                                                        )}
                            ...
                            <Card className="mb-6">
                                <CardHeader>
                                    ...
                                    <p className="text-sm text-gray-600">
                                        Pipeline values for each AE across different time periods
                                    </p>
                                </CardHeader>
                                <CardContent>
                                    {(() => {
                                        ...
                                        Object.keys(
                                            analytics.closing_projections.ae_projections
                                        ).forEach((ae) => {
                                            aeBreakdown[ae] = {
                                                next14: 0,
                                                next30: 0,
                                        ...
                                        hotDeals.forEach((deal) => {
                                            if (
                                                !hiddenDeals.has(deal.id) &&
                                                deal.owner &&
                                                aeBreakdown[deal.owner]
                                            ) {
                                                if (deal.column === 'next14') {
                                                    aeBreakdown[deal.owner].next14 +=
                                                        deal.pipeline || 0;
                                                } else if (deal.column === 'next30') {
                                                    aeBreakdown[deal.owner].next30 +=
                                                        deal.pipeline || 0;
                                                } else if (deal.column === 'next60') {
                                                    aeBreakdown[deal.owner].next60 +=
                                                        deal.pipeline || 0;
                                                }
                                            }
                                        });
                                        ...
                                        // Calculate totals
                                        const totals = {
                                            next14: Object.values(aeBreakdown).reduce(
                                                (sum, ae) => sum + ae.next14,
                                                0
                                            ),
                                            next30: Object.values(aeBreakdown).reduce(
                                                (sum, ae) => sum + ae.next30,
                                                0
                                            ),
                                            next60: Object.values(aeBreakdown).reduce(
                                                (sum, ae) => sum + ae.next60,
                                                0
                                            ),
                                        };
                                        ...
                                        const requestAePipelineSort = (key) => {
                                            let direction = 'ascending';
                                            if (
                                                aePipelineSortConfig.key === key &&
                                                aePipelineSortConfig.direction === 'ascending'
                                            ) {
                                                direction = 'descending';
                                            }
                                        ...
                                        // Sort AE breakdown
                                        const sortedAeBreakdown = Object.entries(aeBreakdown).sort(
                                            ([aeA, valuesA], [aeB, valuesB]) => {
                                                if (aePipelineSortConfig.key === 'ae') {
                                                    // Alphabetical sort
                                                    return aePipelineSortConfig.direction ===
                                                        'ascending'
                                                ...
                                                <table className="w-full text-sm">
                                                    ...
                                                    <tbody>
                                                        {sortedAeBreakdown.map(([ae, values]) => (
                                                            ...
                                                            >
                                                                ...
                                                                <td className="text-right p-3">
                                                                    {formatValue(values.next14)}
                                                                </td>
                                                                <td className="text-right p-3">
                                                                    {formatValue(values.next30)}
                                                                </td>
                                                                <td className="text-right p-3">
                                                                    {formatValue(values.next60)}
                                                                </td>
                                                            </tr>
                                                        ))}
                                                        <tr className="border-t-2 bg-blue-50 font-bold">
                                                            <td className="p-3">TOTAL</td>
                                                            <td className="text-right p-3">
                                                                {formatValue(totals.next14)}
                                                            </td>
                                                            <td className="text-right p-3">
                                                                {formatValue(totals.next30)}
                                                            </td>
                                                            <td className="text-right p-3">
                                                                {formatValue(totals.next60)}
                                                            </td>
                                                        </tr>
                                                    </tbody>
                                                </table>
